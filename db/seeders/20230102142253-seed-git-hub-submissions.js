    ...
    await queryInterface.bulkInsert(
      ...
      [
        ...
        },
        {
          cadetId: 2,
          chapterId: 22,
          repoUrl: 'https://github.com/Jermaine-ye/recipe-site',
          createdAt: new Date(),
          updatedAt: new Date(),
        },
        {
          cadetId: 2,
          chapterId: 23,
          repoUrl: 'https://github.com/Jermaine-ye/portfolio',
          createdAt: new Date(),
          updatedAt: new Date(),
        },
        {
          cadetId: 3,
          chapterId: 24,
          repoUrl: 'https://github.com/Jermaine-ye/world-clock',
          createdAt: new Date(),
          updatedAt: new Date(),
        },
        {
          cadetId: 2,
          chapterId: 25,
          repoUrl: 'https://github.com/Jermaine-ye/high-card',
          createdAt: new Date(),
          updatedAt: new Date(),
        },
        {
